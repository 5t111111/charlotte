...
### Running charlotte Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start charlotte locally by running:
...
Then you can interact with charlotte by typing `charlotte help`.

    charlotte> charlotte help
    charlotte animate me <query> - The same thing as `image me`, except adds [snip]
    charlotte help - Displays all of the help commands that charlotte knows about.
    ...
